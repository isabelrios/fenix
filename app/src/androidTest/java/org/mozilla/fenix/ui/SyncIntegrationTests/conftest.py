...
def tps_config(fxa_account, monkeypatch):
    ...
    f= open("/Users/isabelrios/git/isabelrios/fenix/app/src/androidTest/resources/email.txt","w+")
    f.write(fxa_account.email)
    f= open("/Users/isabelrios/git/isabelrios/fenix/app/src/androidTest/resources/password.txt","w+")
